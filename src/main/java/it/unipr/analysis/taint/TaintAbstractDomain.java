...
public abstract class TaintAbstractDomain
	...
	private TaintAbstractDomain copyWithMemory(TaintElement newMemory) {
		TaintElement[] arrCopy = this.circularArray.clone();
		TaintAbstractDomain res = mk(arrCopy, newMemory);
		res.head = this.head;
		res.tail = this.tail;
		return res;
	}
