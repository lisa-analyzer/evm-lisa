...
import it.unipr.analysis.operator.GtOperator;
...
/**
 * Gt opcode of the program to analyze.
 */
public class Gt extends Statement {

	/**
	 * Builds a Gt opcode happening at the given source location.
	 * 
	 * @param cfg      the cfg that this statement belongs to
	 * @param location the location where this statement is defined within the
	 *                     program
	 */
	public Gt(CFG cfg, CodeLocation location) {
		super(cfg, location);
	}
	...
	public <A extends AbstractState<A, H, V, T>,
		...
		return entryState.smallStepSemantics(new it.unive.lisa.symbolic.value.UnaryExpression(Untyped.INSTANCE, dummy,
				GtOperator.INSTANCE, getLocation()), this);
	}
}