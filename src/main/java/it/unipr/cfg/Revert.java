...
import it.unipr.analysis.operator.RevertOperator;
...
/**
 * Revert opcode of the program to analyze.
 */
public class Revert extends Statement {

	/**
	 * Builds a Revert opcode happening at the given source location.
	 * 
	 * @param cfg      the cfg that this statement belongs to
	 * @param location the location where this statement is defined within the
	 *                     program
	 */
	public Revert(CFG cfg, CodeLocation location) {
		super(cfg, location);
	}
	...
	public <A extends AbstractState<A, H, V, T>,
		...
		return entryState.smallStepSemantics(new it.unive.lisa.symbolic.value.UnaryExpression(Untyped.INSTANCE, dummy,
				RevertOperator.INSTANCE, getLocation()), this);
	}
}