...
import it.unipr.analysis.operator.Swap11Operator;
...
/**
 * Swap11 opcode of the program to analyze.
 */
public class Swap11 extends Swap {

	/**
	 * Builds a Swap11 opcode happening at the given source location.
	 * 
	...
	public <A extends AbstractState<A, H, V, T>,
		...
		return entryState.smallStepSemantics(new it.unive.lisa.symbolic.value.UnaryExpression(Untyped.INSTANCE, dummy,
				Swap11Operator.INSTANCE, getLocation()), this);
	}
}