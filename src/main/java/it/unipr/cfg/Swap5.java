...
import it.unipr.analysis.operator.Swap5Operator;
...
/**
 * Swap5 opcode of the program to analyze.
 */
public class Swap5 extends Swap {

	/**
	 * Builds a Swap5 opcode happening at the given source location.
	 * 
	...
	public <A extends AbstractState<A, H, V, T>,
		...
		return entryState.smallStepSemantics(new it.unive.lisa.symbolic.value.UnaryExpression(Untyped.INSTANCE, dummy,
				Swap5Operator.INSTANCE, getLocation()), this);
	}
}