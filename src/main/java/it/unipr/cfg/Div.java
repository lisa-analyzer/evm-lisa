...
import it.unipr.analysis.operator.DivOperator;
...
/**
 * Div opcode of the program to analyze.
 */
public class Div extends Statement {

	/**
	 * Builds a Div opcode happening at the given source location.
	 * 
	 * @param cfg      the cfg that this statement belongs to
	 * @param location the location where this statement is defined within the
	 *                     program
	 */
	public Div(CFG cfg, CodeLocation location) {
		super(cfg, location);
	}
	...
	public <A extends AbstractState<A, H, V, T>,
		...
		return entryState.smallStepSemantics(new it.unive.lisa.symbolic.value.UnaryExpression(Untyped.INSTANCE, dummy,
				DivOperator.INSTANCE, getLocation()), this);
	}
}