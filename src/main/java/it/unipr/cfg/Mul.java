...
import it.unipr.analysis.operator.MulOperator;
...
/**
 * Mul opcode of the program to analyze.
 */
public class Mul extends Statement {

	/**
	 * Builds a Mul opcode happening at the given source location.
	 * 
	 * @param cfg      the cfg that this statement belongs to
	 * @param location the location where this statement is defined within the
	 *                     program
	 */
	public Mul(CFG cfg, CodeLocation location) {
		super(cfg, location);
	}
	...
	public <A extends AbstractState<A, H, V, T>,
		...
		return entryState.smallStepSemantics(new it.unive.lisa.symbolic.value.UnaryExpression(Untyped.INSTANCE, dummy,
				MulOperator.INSTANCE, getLocation()), this);
	}
}