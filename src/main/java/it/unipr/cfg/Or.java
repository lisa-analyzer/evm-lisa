...
import it.unipr.analysis.operator.OrOperator;
...
/**
 * Or opcode of the program to analyze.
 */
public class Or extends Statement {

	/**
	 * Builds a Or opcode happening at the given source location.
	 * 
	 * @param cfg      the cfg that this statement belongs to
	 * @param location the location where this statement is defined within the
	 *                     program
	 */
	public Or(CFG cfg, CodeLocation location) {
		super(cfg, location);
	}
	...
	public <A extends AbstractState<A, H, V, T>,
		...
		return entryState.smallStepSemantics(new it.unive.lisa.symbolic.value.UnaryExpression(Untyped.INSTANCE, dummy,
				OrOperator.INSTANCE, getLocation()), this);
	}
}