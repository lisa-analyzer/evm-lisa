...
import it.unipr.analysis.operator.Swap14Operator;
...
/**
 * Swap14 opcode of the program to analyze.
 */
public class Swap14 extends Swap {

	/**
	 * Builds a Swap14 opcode happening at the given source location.
	 * 
	...
	public <A extends AbstractState<A, H, V, T>,
		...
		return entryState.smallStepSemantics(new it.unive.lisa.symbolic.value.UnaryExpression(Untyped.INSTANCE, dummy,
				Swap14Operator.INSTANCE, getLocation()), this);
	}
}