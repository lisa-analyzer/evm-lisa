...
import it.unipr.analysis.operator.Swap8Operator;
...
/**
 * Swap8 opcode of the program to analyze.
 */
public class Swap8 extends Swap {

	/**
	 * Builds a Swap8 opcode happening at the given source location.
	 * 
	...
	public <A extends AbstractState<A, H, V, T>,
		...
		return entryState.smallStepSemantics(new it.unive.lisa.symbolic.value.UnaryExpression(Untyped.INSTANCE, dummy,
				Swap8Operator.INSTANCE, getLocation()), this);
	}
}