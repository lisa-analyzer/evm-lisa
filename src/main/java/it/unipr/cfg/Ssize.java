...
/**
 * Ssize opcode of the program to analyze.
 */
public class Ssize extends Statement {

	/**
	 * Builds a Ssize opcode happening at the given source location.
	 * 
	 * @param cfg      the cfg that this statement belongs to
	 * @param location the location where this statement is defined within the
	 *                     program
	 */
	public Ssize(CFG cfg, CodeLocation location) {
		super(cfg, location);
	}
