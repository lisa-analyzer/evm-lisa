...
import it.unipr.analysis.operator.ExpOperator;
...
/**
 * Exp opcode of the program to analyze.
 */
public class Exp extends Statement {

	/**
	 * Builds a Exp opcode happening at the given source location.
	 * 
	 * @param cfg      the cfg that this statement belongs to
	 * @param location the location where this statement is defined within the
	 *                     program
	 */
	public Exp(CFG cfg, CodeLocation location) {
		super(cfg, location);
	}
	...
	public <A extends AbstractState<A, H, V, T>,
		...
		return entryState.smallStepSemantics(new it.unive.lisa.symbolic.value.UnaryExpression(Untyped.INSTANCE, dummy,
				ExpOperator.INSTANCE, getLocation()), this);
	}
}