...
/**
 * Txexecgas opcode of the program to analyze.
 */
public class Txexecgas extends Statement {

	/**
	 * Builds a Txexecgas opcode happening at the given source location.
	 * 
	 * @param cfg      the cfg that this statement belongs to
	 * @param location the location where this statement is defined within the
	 *                     program
	 */
	public Txexecgas(CFG cfg, CodeLocation location) {
		super(cfg, location);
	}
