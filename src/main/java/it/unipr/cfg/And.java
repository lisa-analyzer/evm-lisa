...
import it.unipr.analysis.operator.AndOperator;
...
/**
 * And opcode of the program to analyze.
 */
public class And extends Statement {

	/**
	 * Builds an And opcode happening at the given source location.
	 * 
	 * @param cfg      the cfg that this statement belongs to
	 * @param location the location where this statement is defined within the
	 *                     program
	 */
	public And(CFG cfg, CodeLocation location) {
		super(cfg, location);
	}
	...
	public <A extends AbstractState<A, H, V, T>,
		...
		return entryState.smallStepSemantics(new it.unive.lisa.symbolic.value.UnaryExpression(Untyped.INSTANCE, dummy,
				AndOperator.INSTANCE, getLocation()), this);
	}
}