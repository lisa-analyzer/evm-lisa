...
/**
 * A Push16 opcode with a single sub-expression.
 */
public class Push16 extends Push {
	 ...
	 */
	public Push16(CFG cfg, CodeLocation location, HexDecimalLiteral expression) {
		super(cfg, location, "PUSH16", expression);
	}

	@Override
	public String toString() {
		return "PUSH16 " + getSubExpression();
	}
