...
/**
 * A Push13 opcode with a single sub-expression.
 */
public class Push13 extends Push {
	 ...
	 */
	public Push13(CFG cfg, CodeLocation location, HexDecimalLiteral expression) {
		super(cfg, location, "PUSH13", expression);
	}

	@Override
	public String toString() {
		return "PUSH13 " + getSubExpression();
	}
}