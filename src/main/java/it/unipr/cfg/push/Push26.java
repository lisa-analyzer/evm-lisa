...
/**
 * A Push26 opcode with a single sub-expression.
 */
public class Push26 extends Push {
	 ...
	 */
	public Push26(CFG cfg, CodeLocation location, HexDecimalLiteral expression) {
		super(cfg, location, "PUSH26", expression);
	}

	@Override
	public String toString() {
		return "PUSH26 " + getSubExpression();
	}
}