...
/**
 * Push-zero opcode of the program to analyze.
 */
public class Push0 extends Statement {

	/**
	 * Builds a push-zero opcode happening at the given source location.
	 * 
	 * @param cfg      the cfg that this statement belongs to
	 * @param location the location where this statement is defined within the
	 *                     program
	 */
	public Push0(CFG cfg, CodeLocation location) {
		super(cfg, location);
	}
