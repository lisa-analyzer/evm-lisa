...
/**
 * A Push28 opcode with a single sub-expression.
 */
public class Push28 extends Push {
	 ...
	 */
	public Push28(CFG cfg, CodeLocation location, HexDecimalLiteral expression) {
		super(cfg, location, "PUSH28", expression);
		// TODO Auto-generated constructor stub
	}

	@Override
	public String toString() {
		return "PUSH28 " + getSubExpression();
	}
}