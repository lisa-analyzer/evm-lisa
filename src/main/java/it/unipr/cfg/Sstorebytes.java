...
/**
 * Sstorebytes opcode of the program to analyze.
 */
public class Sstorebytes extends Statement {

	/**
	 * Builds a Sstorebytes opcode happening at the given source location.
	 * 
	 * @param cfg      the cfg that this statement belongs to
	 * @param location the location where this statement is defined within the
	 *                     program
	 */
	public Sstorebytes(CFG cfg, CodeLocation location) {
		super(cfg, location);
	}
