...
import it.unipr.analysis.operator.CallOperator;
...
/**
 * Call opcode of the program to analyze.
 */
public class Call extends Statement {

	/**
	 * Builds a Call opcode happening at the given source location.
	 * 
	 * @param cfg      the cfg that this statement belongs to
	 * @param location the location where this statement is defined within the
	 *                     program
	 */
	public Call(CFG cfg, CodeLocation location) {
		super(cfg, location);
	}
	...
	public <A extends AbstractState<A, H, V, T>,
		...
		return entryState.smallStepSemantics(new it.unive.lisa.symbolic.value.UnaryExpression(Untyped.INSTANCE, dummy,
				CallOperator.INSTANCE, getLocation()), this);
	}
}