...
import it.unipr.analysis.operator.Dup2Operator;
...
/**
 * Dup2 opcode of the program to analyze.
 */
public class Dup2 extends Dup {

	/**
	 * Builds a Dup2 opcode happening at the given source location.
	 * 
	...
	public <A extends AbstractState<A, H, V, T>,
		...
		return entryState.smallStepSemantics(new it.unive.lisa.symbolic.value.UnaryExpression(Untyped.INSTANCE, dummy,
				Dup2Operator.INSTANCE, getLocation()), this);
	}
}