...
import it.unipr.crosschain.taint.AccessControlIncompletenessAbstractDomain;
 ...
 */
public class AccessControlIncompletenessAbstractSemanticsTest extends EVMBytecodeAnalysisExecutor {
	...
	private static CronConfiguration createConfiguration(String testDir, String subDir, String programFile,
		...
		conf.abstractState = new SimpleAbstractState<MonolithicHeap, RelationalTaintAbstractDomain,
				TypeEnvironment<InferredTypes>>(
						new MonolithicHeap(), new AccessControlIncompletenessAbstractDomain(),
