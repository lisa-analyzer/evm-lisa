...
contract BEP20CappedUpgradeSafe is BEP20UpgradeSafe {
    ...
    function __BEP20Capped_init(uint256 cap) internal initializer {
        __Context_init_unchained();
        __BEP20Capped_init_unchained(cap);
    }

    function __BEP20Capped_init_unchained(uint256 cap) internal initializer {
...
contract TRONPAD is BEP20CappedUpgradeSafe, OwnableUpgradeSafe, LGEWhitelisted {
    ...
    function initialize(uint256 totalSupply)
        ...
        initializer
    {
        __BEP20_init("TRONPAD.network", "TRONPAD");
        __BEP20Capped_init(totalSupply);
        __Ownable_init();
