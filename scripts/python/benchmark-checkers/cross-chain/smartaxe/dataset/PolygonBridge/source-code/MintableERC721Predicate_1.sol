...
contract MintableERC721Predicate is ITokenPredicate, AccessControlMixin, Initializable, IERC721Receiver {
        ...
        only(MANAGER_ROLE)
    {
        ...
        require(bytes32(logTopicRLPList[0].toUint()) == TRANSFER_EVENT_SIG, "MintableERC721Predicate: INVALID_SIGNATURE");

        // If it's a simple exit (without metadata coming from L2 to L1)
