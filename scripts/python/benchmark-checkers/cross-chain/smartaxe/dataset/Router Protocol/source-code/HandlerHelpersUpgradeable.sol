...
contract HandlerHelpersUpgradeable is Initializable, ContextUpgradeable, AccessControlUpgradeable, IERCHandler {
    ...
    function withdraw(address tokenAddress, address recipient, uint256 amount) public virtual override {}

    /// @notice Used to withdraw fees from fee manager.
    /// @param tokenAddress Address of token contract to release.
    /// @param recipient Address to release tokens to.
    /// @param amount the amount of tokens to release.
    function withdrawFees(address tokenAddress, address recipient, uint256 amount) public virtual override {}
